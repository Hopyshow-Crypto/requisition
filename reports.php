...
if (!in_array($_SESSION['department'], $allowedDepartments) && $_SESSION['user_level'] < 4) {
    redirect('index.php');
}
                        ...
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-2xl font-bold text-gray-900">
                                    <?php echo formatCurrency($monthlyStats['total_amount'] ?? 0); ?>
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-lg shadow-sm p-6 border border-gray-200">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-2xl font-bold text-gray-900">
                                    <?php echo formatCurrency($yearlyStats['total_amount'] ?? 0); ?>
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-lg shadow-sm p-6 border border-gray-200">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-2xl font-bold text-gray-900">
                                    <?php echo formatCurrency($retirementStats['total_retired'] ?? 0); ?>
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-lg shadow-sm p-6 border border-gray-200">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-2xl font-bold text-gray-900">
                                    <?php echo formatCurrency($retirementStats['total_returned'] ?? 0); ?>
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="p-6">
                            <div class="space-y-4">
                                <div class="flex justify-between items-center p-4 bg-gray-50 rounded-lg">
                                    ...
                                    <span class="text-lg font-bold text-gray-900"><?php echo $retirementStats['count_with_retirement'] ?? 0; ?></span>
                                </div>
                                <div class="flex justify-between items-center p-4 bg-green-50 rounded-lg">
                                    <span class="text-sm font-medium text-gray-700">Total Amount Retired</span>
                                    <span class="text-lg font-bold text-green-600"><?php echo formatCurrency($retirementStats['total_retired'] ?? 0); ?></span>
                                </div>
                                <div class="flex justify-between items-center p-4 bg-blue-50 rounded-lg">
                                    <span class="text-sm font-medium text-gray-700">Total Amount Returned</span>
                                    <span class="text-lg font-bold text-blue-600"><?php echo formatCurrency($retirementStats['total_returned'] ?? 0); ?></span>
                                </div>
                                <div class="flex justify-between items-center p-4 bg-purple-50 rounded-lg">
                                    <span class="text-sm font-medium text-gray-700">Net Retirement</span>
                                    <span class="text-lg font-bold text-purple-600">
                                        <?php echo formatCurrency(($retirementStats['total_retired'] ?? 0) - ($retirementStats['total_returned'] ?? 0)); ?>
                                    </span>
                                </div>
                            </div>
                        </div>
