...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $result = $requisition->create($data);
    
    if ($result['success']) {
        $message = 'Requisition ' . ($data['status'] === 'draft' ? 'saved as draft' : 'submitted') . ' successfully!';
        $messageType = 'success';
        ...
        $message = $result['message'] ?? 'Failed to create requisition';
        $messageType = 'error';
    }
}
...
<head>
    ...
    <title><?php echo APP_NAME; ?> - Create Requisition</title>
            ...
            <div class="max-w-4xl mx-auto">
                <div class="bg-white rounded-lg shadow-sm border border-gray-200">
                    <div class="px-6 py-4 border-b border-gray-200">
                        <h1 class="text-2xl font-bold text-gray-900">Create New Requisition</h1>
                        <p class="text-gray-600 mt-1">Fill in the details for your payment requisition</p>
                    </div>
                    ...
                    <form method="POST" class="p-6 space-y-6">
                            ...
                            <div>
                                ...
                                <select id="category" name="category" required
                                    ...
                                    <?php foreach ($categories as $category): ?>
                                        <option value="<?php echo $category; ?>" <?php echo (($_POST['category'] ?? '') === $category) ? 'selected' : ''; ?>>
                                            <?php echo $category; ?>
                                        </option>
                                    <?php endforeach; ?>
                                </select>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                            ...
                            <div>
                                ...
                                <select id="currency" name="currency"
                                        class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                                    <option value="NGN" <?php echo (($_POST['currency'] ?? 'NGN') === 'NGN') ? 'selected' : ''; ?>>NGN (₦)</option>
                            ...
                            <div>
                                ...
                                <select id="department" name="department" required
                                    ...
                                    <?php foreach ($departments as $dept): ?>
                                        <option value="<?php echo $dept; ?>" <?php echo (($_POST['department'] ?? $_SESSION['department']) === $dept) ? 'selected' : ''; ?>>
                                            <?php echo $dept; ?>
                                        </option>
                                    <?php endforeach; ?>
                                </select>
                        ...
                        <div>
                            ...
                            <textarea id="description" name="description" required rows="4"
                                      class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                      placeholder="Provide detailed description of the requisition"><?php echo htmlspecialchars($_POST['description'] ?? ''); ?></textarea>
                        </div>
                        ...
                        <div>
                            ...
                            <textarea id="justification" name="justification" required rows="3"
                                      class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                      placeholder="Explain why this requisition is necessary"><?php echo htmlspecialchars($_POST['justification'] ?? ''); ?></textarea>
                        </div>
