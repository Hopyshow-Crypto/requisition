...
if ($_SESSION['user_level'] < 4 && strpos($_SESSION['has_roles'], 'admin') === false) {
    redirect('index.php');
}
...
<body class="bg-gray-50">
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                <?php foreach ($users as $u): ?>
                                    <tr class="hover:bg-gray-50">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                            <?php echo htmlspecialchars($u['department'] ?? 'N/A'); ?>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                            Level <?php echo $u['user_level']; ?>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
            ...
            <div class="mt-3">
                ...
                <form id="userForm" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <select id="modalUserLevel" name="user_level"
                                class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
    ...
    <script>
        ...
        function editUser(user) {
            ...
            document.getElementById('modalUserLevel').value = user.user_level;
